        ...
        <div class="content-block__container container  is--login  is--signup">
            ...
            <div class="form__block  is--signup">
                ...
                elseif ($arResult["USE_EMAIL_CONFIRMATION"] === "Y"):
                    ?>
                    <p class="header__item-title"><? echo GetMessage("REGISTER_EMAIL_WILL_BE_SENT") ?></p>
                <? endif ?>
                <form class="form__panel  is--signup" data-validation method="post" action="<?= POST_FORM_ACTION_URI ?>"
