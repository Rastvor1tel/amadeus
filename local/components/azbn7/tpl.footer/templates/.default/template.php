					...
					<div class="footer__navbar-cols cols">
						<ul class="footer__navbar-nav">
							<li class="footer__navbar-item">
								<a href="<?=AZBN__ROOT;?>/about/" class="footer__navbar-link">
									О нас
								</a>
							</li>
							<li class="footer__navbar-item">
							...
							<li class="footer__navbar-item">
								<a href="<?=AZBN__ROOT;?>/about/news/" class="footer__navbar-link">
									Новости
								</a>
							</li>
							<li class="footer__navbar-item">
								<a href="<?=AZBN__ROOT;?>/contacts/" class="footer__navbar-link">
									Контакты
								</a>
							</li>
						</ul>
			...
			<div class="footer__info">
				<div class="footer__row row  is--base">
					<div class="footer__cols cols  is--copyright">
						&copy; Amadeus 2016 - <?=date('Y');?>. Все права защищены.
					</div>
...
<script src="<?=SITE_TEMPLATE_PATH;?>/js/document-ready.js" ></script>
