                    ...
                    <div class="social__row row  is--header">
                        <?if($GLOBALS['TELEGRAM']):?>
                            <div class="social__cols cols  is--header">
                                <a href="<?=$GLOBALS['TELEGRAM']?>" class="social__item  is--tg  is--header" target="_blank">
                        ...
                        <?if($GLOBALS['VIBER']):?>
                            <div class="social__cols cols  is--header">
                                <a href="<?=$GLOBALS['VIBER']?>" class="social__item  is--viber  is--header" target="_blank">
                        ...
                        <?if($GLOBALS['WHATSAPP']):?>
                            <div class="social__cols cols  is--header">
                                <a href="<?=$GLOBALS['WHATSAPP']?>" class="social__item  is--wa  is--header" target="_blank">
