    ...
    <div class="header-block__panel  is--wholesale">
        <div class="header-block__inner  is--wholesale">
            ...
            <div class="header-block__btn  is--wholesale">
                ...
                <a href="<?=$arResult['DISPLAY_PROPERTIES']['BUTTONS']['DESCRIPTION'][$key]?>" class="btn__item" <?=strpos($arResult['DISPLAY_PROPERTIES']['BUTTONS']['DESCRIPTION'][$key], '#modal')!==false?' data-toggle="modal" data-target="'.$arResult['DISPLAY_PROPERTIES']['BUTTONS']['DESCRIPTION'][$key].'"':'';?>>
                    ...
                    <div class="social__row row  is--wholesale">
                        <?if($GLOBALS['TELEGRAM']):?>
                            <div class="social__cols cols  is--wholesale">
                                <a href="<?=$GLOBALS['TELEGRAM']?>" class="social__item  is--tg  is--wholesale" target="_blank">
                        ...
                        <?if($GLOBALS['VIBER']):?>
                            <div class="social__cols cols  is--wholesale">
                                <a href="<?=$GLOBALS['VIBER']?>" class="social__item  is--viber  is--wholesale" target="_blank">
                        ...
                        <?if($GLOBALS['WHATSAPP']):?>
                            <div class="social__cols cols  is--wholesale">
                                <a href="<?=$GLOBALS['WHATSAPP']?>" class="social__item  is--wa  is--wholesale" target="_blank">
