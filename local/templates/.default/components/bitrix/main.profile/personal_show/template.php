<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die(); ?>
    <div class="content-block__row row  is--gutter  is--gap-40  is--profile">
        <div class="content-block__cols cols  is--profile  is--left">
            <div class="cabinet__avatar-preview">
                <img src="<?=$arResult['arUser']['PHOTO']?>" class="img-responsive" alt="">
                <div class="cabinet__avatar-btn">
                    <a href="<?=$arResult['EDIT_LINK']?>" class="btn-icon__item" title="Редактировать">
        ...
        <div class="content-block__cols cols  is--profile  is--right">
            <div class="cabinet__profile-panel  is--info">
                <div class="cabinet__profile-heading-group  is--info">
                    <div class="cabinet__profile-heading  is--info">
                        Персональные данные
                    </div>
                    <div class="cabinet__profile-btn  is--info">
                        <a href="<?=$arResult['EDIT_LINK']?>" class="btn-icon__item" title="Редактировать">
                            <svg class="icon-svg icon-icon-edit" role="img">
                                <use xlink:href="<?= TEMPLATE_DIR ?>/img/svg/sprite.svg#icon-edit"></use>
                            </svg>
                ...
                <div class="cabinet__profile-elem  is--info">
                    <div class="cabinet__profile-elem-label  is--info">ФИО:</div>
                    <div class="cabinet__profile-elem-value  is--info"><?=$arResult['arUser']['FIO']?></div>
                </div>
                <div class="cabinet__profile-elem  is--info">
                    <div class="cabinet__profile-elem-label  is--info">Телефон:</div>
                    <div class="cabinet__profile-elem-value  is--info"><?=$arResult['arUser']['PERSONAL_PHONE']?></div>
                </div>
                <div class="cabinet__profile-elem  is--info">
                    <div class="cabinet__profile-elem-label  is--info">E-mail:</div>
                    <div class="cabinet__profile-elem-value  is--info"><?=$arResult['arUser']['EMAIL']?></div>
                </div>
                <div class="cabinet__profile-elem  is--info">
                    <div class="cabinet__profile-elem-label  is--info">Пол:</div>
                    <div class="cabinet__profile-elem-value  is--info"><?=$arResult['arUser']['GENDER']?></div>
                </div>
            </div>
        </div>
        <div class="content-block__cols cols  is--profile  is--left">
            <div class="cabinet__profile-panel  is--pass">
                <div class="cabinet__profile-heading-group  is--pass">
                    <div class="cabinet__profile-heading  is--pass">
                        Пароль
                    </div>
                    <div class="cabinet__profile-btn  is--pass">
                        <a href="<?=$arResult['EDIT_LINK']?>" class="btn-icon__item" title="Редактировать">
                            <svg class="icon-svg icon-icon-edit" role="img">
                                <use xlink:href="<?= TEMPLATE_DIR ?>/img/svg/sprite.svg#icon-edit"></use>
                            </svg>
                ...
                <div class="cabinet__profile-note  is--pass">
                    Здесь Вы можете изменить свой пароль для входа в личный кабинет
                </div>
            </div>
        </div>
        <div class="content-block__cols cols  is--profile  is--right">
            <div class="cabinet__profile-panel  is--address">
                <div class="cabinet__profile-heading-group  is--address">
                    <div class="cabinet__profile-heading  is--address">
                        Адреса доставки
                    </div>
                    <div class="cabinet__profile-btn  is--address">
                        <a href="<?=$arResult['EDIT_LINK']?>" class="btn-icon__item    " title="Добавить">
                ...
                <div class="cabinet__profile-elem  is--address">
                    <?foreach($arResult['arUser']['UF_DELIVERYADRESS'] as $arAdress):?>
                        <div class="cabinet__profile-label  is--address">
                            <?=$arAdress?>
                        </div>
                    <?endforeach;?>
                    <?/*<div class="cabinet__profile-elem-btn  is--right  is--address">
                        <button type="button" class="btn-icon__item  is--icon" title="Редактировать">
                            <svg class="icon-svg icon-icon-edit" role="img">
                                <use xlink:href="<?= TEMPLATE_DIR ?>/img/svg/sprite.svg#icon-edit"></use>
                            </svg>
                        </button>
                    </div>
                    <div class="cabinet__profile-elem-btn  is--address">
                        <button type="button" class="btn-icon__item  is--icon" title="Удалить">
                            <svg class="icon-svg icon-icon-del" role="img">
                                <use xlink:href="<?= TEMPLATE_DIR ?>/img/svg/sprite.svg#icon-del"></use>
                            </svg>
                        </button>
                    </div>*/?>
                </div>
